      ...
      <Row align='center' justify='center'>
        <Col lg={3} md={4} sm={12}>
          ...
          <div className={styles.desc}>
            What does your financial life look like and what is your goal for
            investing? What is the right risk limit for you?
          </div>
        </Col>
        <Col lg={3} md={4} sm={12}>
          ...
          <div className={styles.desc}>
            ...
            suits the level of risk and the time period that is convenient for
            you. It can be customized at any time.
          </div>
        </Col>
        <Col lg={3} md={4} sm={12}>
          ...
          <div className={styles.desc}>
            Even while you sleep. Once your investment begins, we are constantly
            working to rebalance your portfolio
          </div>
        </Col>
      </Row>
    </Container>
